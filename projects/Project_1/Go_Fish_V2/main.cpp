 ...
 * Created on April 8th, 2019, 12:36 AM
 * Purpose: Distribute 7 cards to user and computer
 * Version: 2
 */
...
int main(int argc, char** argv) {    
    ...
    }while(card1==card2);           //Choosing 2nd card till conditions not met
    ...
    }while(card1==card3||card2==card3);//Choosing 3rd card till conditions met
    ...
    }while(card1==card4||card2==card4||  //Choosing 4th card till conditions met
            card3==card4);
    ...
    }while(card1==card5||card2==card5|| //Choosing 5th card till conditions met
    ...
    }while(card1==card6||card2==card6|| //Choosing 6th card till conditions met
            card3==card6||card4==card6||card5==card6);
    ...
    do{                                     //Choosing 7th card
        ...
        dekFile.close();                //Closing deck file after 3rd card chosen
        usrFile<<card7<<endl;           //Inputing 7th card to user file
        usrFile.close();                //Closing user input file
    }while(card1==card7||card2==card7|| //Choosing 6th card till conditions met
            card3==card7||card4==card7||card5==card7||card6==card7);
    ...
    cout<<"Com Card Pick = "<<pckCard<<" -> "<<cmCrd1<<endl;
    ...
    cout<<"Com Card Pick = "<<pckCard<<" -> "<<cmCrd2<<endl;
    ...
    cout<<"Com Card Pick = "<<pckCard<<" -> "<<cmCrd3<<endl;
    ...
    cout<<"Com Card Pick = "<<pckCard<<" -> "<<cmCrd4<<endl;
    ...
    cout<<"Com Card Pick = "<<pckCard<<" -> "<<cmCrd5<<endl;
    ...
    cout<<"Com Card Pick = "<<pckCard<<" -> "<<cmCrd6<<endl;
    ...
    do{
        do{                                     //Choosing 7th Computer card
            ...
            dekFile.close();                   //Closing deck file after 5th card chosen
            comFile<<cmCrd7<<endl;             //Input 7th card to computer file
    ...
    cout<<"Com Card Pick = "<<pckCard<<" -> "<<cmCrd7<<endl;
